不熟悉 erlang，不过 joyent 这篇讲 node.js 错误处理的文章挺有 let it crash 精髓： 《[Joyent | Error Handling**](https://link.zhihu.com/?target=https%3A//www.joyent.com/node-js/production/design/errors)》
