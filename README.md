...
| [数据结构与算法](./数据结构与算法) | [algorithm-snippets](https://github.com/wx-chevalier/algorithm-snippets) | [面向对象的设计模式](./面向对象的设计模式) | [design-pattern-snippets](https://github.com/wx-chevalier/design-pattern-snippets) | [整洁与重构](./整洁与重构) | [软件架构设计](./软件架构设计) | [研发方式与工具](./研发方式与工具) |
| ---------------------------------- | ------------------------------------------------------------------------ | ------------------------------------------ | ---------------------------------------------------------------------------------- | -------------------------- | ------------------------------ | ---------------------------------- |
